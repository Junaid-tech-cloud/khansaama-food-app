        ...
        <div className="container" data-aos="fade-up">
          ...
          >
            ...
            <div className="col-lg-6 menu-item filter-specialty">
              <img
                src={require("../../assets/img/menu/bread-barrel.jpg")}
                className="menu-img"
                alt="w"
              />
              <div className="menu-content">
            ...
            <div className="col-lg-6 menu-item filter-starters">
              <img
                src={require("../../assets/img/menu/cake.jpg")}
                className="menu-img"
                alt="w"
              />
              <div className="menu-content">
            ...
            <div className="col-lg-6 menu-item filter-salads">
              <img
                src={require("../../assets/img/menu/caesar.jpg")}
                className="menu-img"
                alt="e"
              />
              <div className="menu-content">
            ...
            <div className="col-lg-6 menu-item filter-specialty">
              <img
                src={require("../../assets/img/menu/tuscan-grilled.jpg")}
                className="menu-img"
                alt="t"
              />
              <div className="menu-content">
            ...
            <div className="col-lg-6 menu-item filter-starters">
              <img
                src={require("../../assets/img/menu/mozzarella.jpg")}
                className="menu-img"
                alt="t"
              />
              <div className="menu-content">
            ...
            <div className="col-lg-6 menu-item filter-salads">
              <img
                src={require("../../assets/img/menu/greek-salad.jpg")}
                className="menu-img"
                alt="e"
              />
              <div className="menu-content">
            ...
            <div className="col-lg-6 menu-item filter-salads">
              <img
                src={require("../../assets/img/menu/spinach-salad.jpg")}
                className="menu-img"
                alt="e"
              />
              <div className="menu-content">
            ...
            <div className="col-lg-6 menu-item filter-specialty">
              <img
                src={require("../../assets/img/menu/lobster-roll.jpg")}
                className="menu-img"
                alt="a"
              />
              <div className="menu-content">
